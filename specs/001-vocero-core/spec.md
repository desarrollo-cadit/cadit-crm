# Feature Specification: CadIT CRM — Núcleo v1 (001-vocero-core)
...
**Input**: CadIT CRM: CRM de WhatsApp con agente de IA, open source (MIT), self-hosted y
...
conversión; sin él, CadIT es solo una bandeja.
...
Como agencia, instalo CadIT en el VPS de mi cliente en ~15 minutos siguiendo el README:
